...
// ReSharper disable once PrivateFieldCanBeConvertedToLocalVariable
        ...
        internal DisconnectHandler(HttpListener listener, LoggerFunc logger)
        {
            ...
            {
                LogHelper.LogWarning(_logger, "Unable to resolve handles. Disconnect notifications will be ignored.");
            }
        }
